...
namespace FireStationAPI.Migrations
{
    ...
    partial class FirestationContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("FireStationAPI.Entities.Action", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdAction = 2,
                            EndTime = new DateTime(2022, 5, 19, 23, 0, 11, 400, DateTimeKind.Local).AddTicks(2120),
                            NeedSpecialEquipment = true,
                            StartTime = new DateTime(2022, 5, 19, 13, 0, 11, 400, DateTimeKind.Local).AddTicks(2120)
                        },
                        new
                        {
                            IdAction = 3,
            ...
            modelBuilder.Entity("FireStationAPI.Entities.FireTruckAction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdAction = 1,
                            IdFiretruck = 1,
                            AssignmentDate = new DateTime(2022, 2, 18, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            IdAction = 1,
                        ...
                        new
                        {
                            IdAction = 2,
                            IdFiretruck = 6,
                            AssignmentDate = new DateTime(2022, 5, 19, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            IdAction = 3,
                            IdFiretruck = 2,
                            AssignmentDate = new DateTime(2022, 5, 29, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            IdAction = 3,
                        ...
                        new
                        {
                            IdAction = 4,
                            IdFiretruck = 5,
                            AssignmentDate = new DateTime(2022, 5, 24, 4, 0, 0, 0, DateTimeKind.Local)
                        });
                });
